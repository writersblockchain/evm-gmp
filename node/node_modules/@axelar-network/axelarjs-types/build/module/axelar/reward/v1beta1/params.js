...
function createBaseParams() {
    return { externalChainVotingInflationRate: new Uint8Array(), keyMgmtRelativeInflationRate: new Uint8Array() };
}
export const Params = {
    ...
    toJSON(message) {
        ...
        message.keyMgmtRelativeInflationRate !== undefined &&
            (obj.keyMgmtRelativeInflationRate = base64FromBytes(message.keyMgmtRelativeInflationRate !== undefined ? message.keyMgmtRelativeInflationRate : new Uint8Array()));
        return obj;
    },
    create(base) {
