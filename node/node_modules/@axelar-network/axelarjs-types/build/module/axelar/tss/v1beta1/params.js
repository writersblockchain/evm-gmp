...
export const Params = {
    ...
    fromJSON(object) {
        return {
            keyRequirements: Array.isArray(object?.keyRequirements)
                ? object.keyRequirements.map((e) => KeyRequirement.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        message.maxMissedBlocksPerWindow !== undefined && (obj.maxMissedBlocksPerWindow = message.maxMissedBlocksPerWindow
            ? Threshold.toJSON(message.maxMissedBlocksPerWindow)
            : undefined);
        message.unbondingLockingKeyRotationCount !== undefined &&
            (obj.unbondingLockingKeyRotationCount = (message.unbondingLockingKeyRotationCount || Long.ZERO).toString());
    ...
    fromPartial(object) {
        ...
        message.unbondingLockingKeyRotationCount =
            (object.unbondingLockingKeyRotationCount !== undefined && object.unbondingLockingKeyRotationCount !== null)
                ? Long.fromValue(object.unbondingLockingKeyRotationCount)
                : Long.ZERO;
        message.externalMultisigThreshold =
            (object.externalMultisigThreshold !== undefined && object.externalMultisigThreshold !== null)
                ...
                : undefined;
        message.maxSignQueueSize = (object.maxSignQueueSize !== undefined && object.maxSignQueueSize !== null)
