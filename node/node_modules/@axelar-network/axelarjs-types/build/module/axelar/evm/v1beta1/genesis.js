...
export const GenesisState_Chain = {
    ...
    fromJSON(object) {
        return {
            ...
            confirmedDeposits: Array.isArray(object?.confirmedDeposits)
                ? object.confirmedDeposits.map((e) => ERC20Deposit.fromJSON(e))
                : [],
            burnedDeposits: Array.isArray(object?.burnedDeposits)
                ? object.burnedDeposits.map((e) => ERC20Deposit.fromJSON(e))
                : [],
            commandBatches: Array.isArray(object?.commandBatches)
                ? object.commandBatches.map((e) => CommandBatchMetadata.fromJSON(e))
                : [],
            ...
            legacyConfirmedDeposits: Array.isArray(object?.legacyConfirmedDeposits)
                ? object.legacyConfirmedDeposits.map((e) => ERC20Deposit.fromJSON(e))
                : [],
            legacyBurnedDeposits: Array.isArray(object?.legacyBurnedDeposits)
                ? object.legacyBurnedDeposits.map((e) => ERC20Deposit.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.commandBatches) {
            obj.commandBatches = message.commandBatches.map((e) => e ? CommandBatchMetadata.toJSON(e) : undefined);
        }
        else {
            obj.commandBatches = [];
        }
        message.gateway !== undefined && (obj.gateway = message.gateway ? Gateway.toJSON(message.gateway) : undefined);
        if (message.tokens) {
        ...
        message.confirmedEventQueue !== undefined && (obj.confirmedEventQueue = message.confirmedEventQueue
            ? QueueState.toJSON(message.confirmedEventQueue)
            : undefined);
        if (message.legacyConfirmedDeposits) {
            obj.legacyConfirmedDeposits = message.legacyConfirmedDeposits.map((e) => e ? ERC20Deposit.toJSON(e) : undefined);
        }
        else {
            obj.legacyConfirmedDeposits = [];
        }
        if (message.legacyBurnedDeposits) {
            obj.legacyBurnedDeposits = message.legacyBurnedDeposits.map((e) => e ? ERC20Deposit.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        ...
        message.commandQueue = (object.commandQueue !== undefined && object.commandQueue !== null)
        ...
        message.confirmedEventQueue = (object.confirmedEventQueue !== undefined && object.confirmedEventQueue !== null)
