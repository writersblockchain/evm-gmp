    ...
    fromJSON(object) {
        return {
            validators: Array.isArray(object?.validators)
                ? object.validators.map((e) => QueryValidatorsResponse_Validator.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.validators) {
            obj.validators = message.validators.map((e) => e ? QueryValidatorsResponse_Validator.toJSON(e) : undefined);
        }
        else {
            obj.validators = [];
        }
...
export const QueryValidatorsResponse_TssIllegibilityInfo = {
    ...
    create(base) {
        return QueryValidatorsResponse_TssIllegibilityInfo.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryValidatorsResponse_TssIllegibilityInfo();
...
export const QueryValidatorsResponse_Validator = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.tssIllegibilityInfo !== undefined) {
            QueryValidatorsResponse_TssIllegibilityInfo.encode(message.tssIllegibilityInfo, writer.uint32(26).fork())
                .ldelim();
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.tssIllegibilityInfo = QueryValidatorsResponse_TssIllegibilityInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    create(base) {
        return QueryValidatorsResponse_Validator.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryValidatorsResponse_Validator();
