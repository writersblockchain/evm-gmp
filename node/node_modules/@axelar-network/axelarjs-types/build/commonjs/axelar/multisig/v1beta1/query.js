...
exports.KeygenSessionResponse = exports.KeygenSessionRequest = exports.KeyResponse = exports.KeygenParticipant = exports.KeyRequest = exports.NextKeyIDResponse = exports.NextKeyIDRequest = exports.KeyIDResponse = exports.KeyIDRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.KeyIDRequest = {
    ...
    create(base) {
        return exports.KeyIDRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeyIDRequest();
...
exports.KeyIDResponse = {
    ...
    create(base) {
        return exports.KeyIDResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeyIDResponse();
...
exports.NextKeyIDRequest = {
    ...
    create(base) {
        return exports.NextKeyIDRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseNextKeyIDRequest();
        message.chain = object.chain ?? "";
...
exports.NextKeyIDResponse = {
    ...
    create(base) {
        return exports.NextKeyIDResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseNextKeyIDResponse();
        message.keyId = object.keyId ?? "";
...
exports.KeyRequest = {
    ...
    create(base) {
        return exports.KeyRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeyRequest();
        message.keyId = object.keyId ?? "";
...
exports.KeygenParticipant = {
    ...
    create(base) {
        return exports.KeygenParticipant.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenParticipant();
...
exports.KeyResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.startedAtTimestamp !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.startedAtTimestamp), writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.startedAtTimestamp = fromTimestamp(timestamp_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 5:
    ...
    create(base) {
        return exports.KeyResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeyResponse();
        message.keyId = object.keyId ?? "";
        ...
        message.participants = object.participants?.map((e) => exports.KeygenParticipant.fromPartial(e)) || [];
        return message;
    },
};
...
exports.KeygenSessionRequest = {
    ...
    create(base) {
        return exports.KeygenSessionRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenSessionRequest();
        message.keyId = object.keyId ?? "";
...
exports.KeygenSessionResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.startedAtTimestamp !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.startedAtTimestamp), writer.uint32(18).fork()).ldelim();
        }
    ...
    create(base) {
        return exports.KeygenSessionResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenSessionResponse();
        message.startedAt = (object.startedAt !== undefined && object.startedAt !== null)
