...
exports.KeygenStarted = {
    ...
    create(base) {
        return exports.KeygenStarted.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenStarted();
...
exports.KeygenCompleted = {
    ...
    create(base) {
        return exports.KeygenCompleted.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenCompleted();
        message.module = object.module ?? "";
...
exports.KeygenExpired = {
    ...
    create(base) {
        return exports.KeygenExpired.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenExpired();
        message.module = object.module ?? "";
...
exports.PubKeySubmitted = {
    ...
    create(base) {
        return exports.PubKeySubmitted.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePubKeySubmitted();
        message.module = object.module ?? "";
...
function createBaseSigningStarted() {
    return { module: "", sigId: long_1.default.UZERO, keyId: "", pubKeys: {}, payloadHash: new Uint8Array(), requestingModule: "" };
}
exports.SigningStarted = {
    ...
    create(base) {
        return exports.SigningStarted.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSigningStarted();
        message.module = object.module ?? "";
        message.sigId = (object.sigId !== undefined && object.sigId !== null) ? long_1.default.fromValue(object.sigId) : long_1.default.UZERO;
        message.keyId = object.keyId ?? "";
...
exports.SigningStarted_PubKeysEntry = {
    ...
    create(base) {
        return exports.SigningStarted_PubKeysEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSigningStarted_PubKeysEntry();
...
exports.SigningCompleted = {
    ...
    create(base) {
        return exports.SigningCompleted.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSigningCompleted();
        message.module = object.module ?? "";
...
exports.SigningExpired = {
    ...
    create(base) {
        return exports.SigningExpired.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSigningExpired();
        message.module = object.module ?? "";
...
exports.SignatureSubmitted = {
    ...
    create(base) {
        return exports.SignatureSubmitted.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSignatureSubmitted();
        message.module = object.module ?? "";
...
exports.KeyAssigned = {
    ...
    create(base) {
        return exports.KeyAssigned.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeyAssigned();
        message.module = object.module ?? "";
...
exports.KeyRotated = {
    ...
    create(base) {
        return exports.KeyRotated.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeyRotated();
        message.module = object.module ?? "";
...
exports.KeygenOptOut = {
    ...
    create(base) {
        return exports.KeygenOptOut.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenOptOut();
        message.participant = object.participant ?? new Uint8Array();
...
exports.KeygenOptIn = {
    ...
    create(base) {
        return exports.KeygenOptIn.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseKeygenOptIn();
        message.participant = object.participant ?? new Uint8Array();
