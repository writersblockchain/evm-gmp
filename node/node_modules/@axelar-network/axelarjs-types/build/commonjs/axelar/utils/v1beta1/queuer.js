...
exports.QueueState = {
    ...
    create(base) {
        return exports.QueueState.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueueState();
...
exports.QueueState_Item = {
    ...
    create(base) {
        return exports.QueueState_Item.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueueState_Item();
...
exports.QueueState_ItemsEntry = {
    ...
    toJSON(message) {
        ...
        message.value !== undefined && (obj.value = message.value ? exports.QueueState_Item.toJSON(message.value) : undefined);
        return obj;
    },
    create(base) {
        return exports.QueueState_ItemsEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueueState_ItemsEntry();
