...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            routeTimeoutWindow: isSet(object.routeTimeoutWindow) ? long_1.default.fromValue(object.routeTimeoutWindow) : long_1.default.UZERO,
    ...
    toJSON(message) {
        ...
        message.endBlockerLimit !== undefined && (obj.endBlockerLimit = (message.endBlockerLimit || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
